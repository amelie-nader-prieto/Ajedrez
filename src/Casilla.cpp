...
void Casilla::dibuja(int i, int j,int ro,int go, int bo, int rc, int gc, int bc) {
	int sum = i + j;
	glDisable(GL_LIGHTING);
	if (sum % 2)  glColor3ub(ro, go, bo); //(0, 100, 162) ;//glColor3ub(216, 243, 220); //para casillas pares un color mas oscuro//glColor3ub(23, 31, 161);
	else glColor3ub(rc, gc, bc);   //(249, 245, 220);//glColor3ub(82, 183, 136);//glColor3ub(126, 128, 156);
	glBegin(GL_POLYGON);
