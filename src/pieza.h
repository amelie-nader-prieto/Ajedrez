...
public:
	...
	*/
	inline bool ha_movido()const { return primer_movimiento ? false : true; }
	...
	// llamar a esta función si la pieza promociona (sólo funcionará si es un peón)
	inline void set_promocion() { if (tipo == P)promocionado = true; else promocionado = false; }
